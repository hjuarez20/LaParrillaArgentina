            ...
            <div class="container">
                <div class="row">
                    <div class=" col-xs-12 col-sm-12 col-md-4">
                        <h6>Información</h6>
                        <p>Podras ponerte en contacto con nosotros por medio de cualquiera de las Redes Sociales en las que nos encontramos o si prefieres puedes dejarnos un mensaje en la seccion de Contactenos y te responderemos lo antes posible. Te esperamos.</p>
                    </div>
                    <div class=" col-xs-12 col-sm-12 col-md-4">
                        <h6>Eventos</h6>
                        <p>Servicio de Catherin's
                            <br> Fiestas
                            <br> Matrimonios
                            <br> Galas
                            <br> Conferencias
                    ...
                    <div class=" col-xs-12 col-sm-12 col-md-4">
                        ...
                        <p><img src="img/developers/priscila.png"> (CEO) Priscilla Jimenez
                            <br>
                            <img src="img/developers/harold.png"> (Php Senior) Harold Juarez
                            <br>
                            <img src="img/developers/andrea.png"> (Web/Designer) Andrea Palma
                            <br>
                            <img src="img/developers/andrey.png"> (Web/Designer) Andrey Aguirre
                            <br>
                            <img src="img/developers/oscar.png"> (Web/QA) Oscar Noguera
                            <br>
                            <img src="img/developers/victor.png"> (Web/QA) Victor Carranza
                            <br>
                            <img src="img/developers/nelson.png"> (Web Dev) Nelson Guadamuz
                            <br>
                            <img src="img/developers/ricardo.png"> (Web Dev) Ricardo The Cat
                            <br>
